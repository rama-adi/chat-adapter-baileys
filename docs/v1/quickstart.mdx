...
description: "Set up a Chat SDK WhatsApp bot that receives and replies to messages using Baileys"
---
...
<Cards>
  <Card title="Concepts Mapping" href="/docs/chat-adapter-baileys/v1/concepts">Core concepts and how they map to WhatsApp/Baileys primitives.</Card>
  <Card title="Events And Lifecycle" href="/docs/chat-adapter-baileys/v1/events-and-lifecycle">Adapter connection events and lifecycle hooks.</Card>
  <Card title="Thread IDs And Multi-Account" href="/docs/chat-adapter-baileys/v1/thread-ids-and-multi-account">How thread IDs are structured and how to run multiple accounts.</Card>
  <Card title="Formatting And Media" href="/docs/chat-adapter-baileys/v1/formatting-and-media">Sending formatted messages, images, files, and reactions.</Card>
  <Card title="Extensions" href="/docs/chat-adapter-baileys/v1/extensions">Extend the adapter with custom plugins.</Card>
  <Card title="Runnable Example" href="/docs/chat-adapter-baileys/v1/example">A complete, runnable bot example.</Card>
</Cards>
...
See [example.ts](/docs/chat-adapter-baileys/v1/example) for a fuller example with commands, media handling, and reactions.
...
- a **separate auth state**, because each account authenticates independently
...
See [Thread IDs And Multi-Account](/docs/chat-adapter-baileys/v1/thread-ids-and-multi-account) for more detail.
...
You rarely need to construct these manually; the adapter creates and decodes them for you. See [Thread IDs And Multi-Account](/docs/chat-adapter-baileys/v1/thread-ids-and-multi-account) for details.
