---
title: "Thread IDs and Multi-Account"
description: "How WhatsApp thread IDs form from JIDs and how to run multiple accounts in one bot"
---
...
<Cards>
  ...
  <Card title="Events and Lifecycle" href="/docs/chat-adapter-baileys/v2/events-and-lifecycle">connection flow and reconnection</Card>
